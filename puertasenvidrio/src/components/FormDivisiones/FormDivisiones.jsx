...
import { getDivisiones, postDivisiones } from "../../redux/actions";
import { Link } from "react-router-dom";
import styled from "./FormDivisiones.module.css"
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        <p>
          <h4 className={styled.cardTitle}> Name Divisiones:</h4>
          <input
            type="text"
        ...
        <p>
          <h4 className={styled.cardTitle}>  Image Divisiones:</h4>
        ...
        <p>
          <h4 className={styled.cardTitle}>  Description:</h4>
      ...
      <button className={styled.formButton}>ver Divisiones</button>
