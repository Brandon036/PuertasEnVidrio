...
import style from "./TextOne.module.css"
function TextOne() {
  return (
...
INCOMPARABLE!</h4>
         <div className={style.textoo}>  
        <h1>MISION</h1>
     
            <p>
    En <strong> PUERTAS EN VIDRIO </strong> Trabajamos constantemente en mejorar nuestros productos y
...
que realmente quiera escalar a la cima del mundo.
</p>
        </div>
